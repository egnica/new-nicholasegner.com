    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.svgContain}>
        <a
          ...
          aria-label="Visit Nicholas Egner on GitHub"
        >
          <svg
        ...
        <a
          ...
          aria-label="Visit Nicholas Egner on LinkedIn"
        >
          <svg
            className={styles.svgContainSvg}
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://open.spotify.com/user/1224553002?si=c3d54db378354cf5"
          aria-label="Visit Nicholas Egner on Spotify"
        >
          <svg
            className={styles.svgContainSvg}
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          ...
          aria-label="Visit Nicholas Egner on X"
        >
          <svg
            className={styles.svgContainSvg}
            xmlns="http://www.w3.org/2000/svg"
