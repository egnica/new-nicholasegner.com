...
const proofLinks = [
  ...
  { label: "Video Experience", href: "/video-experience" },
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footerInner}>
        <div className={styles.brandBlock}>
          ...
          >
            ...
            />
            <span className={styles.logoText}>Nicholas Egner</span>
          </Link>

          <p>
            Websites, video, and content systems for businesses that need to be
            easier to find, understand, and trust.
          </p>
        </div>
      ...
      <div className={styles.bottomBar}>
        <p>© {year} Nicholas Egner. All rights reserved.</p>
