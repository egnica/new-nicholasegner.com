...
export const projects = [
  {
    ...
    summary:
      "A custom dashboard designed to evaluate, rank, and compare digital business banking experiences across financial institutions.",
    ...
    role: [
      ...
      "Interactive comparison tool development",
    ...
    preview: {
      problem:
        "A complex research program with bank scores, feature categories, video examples, downloadable materials, and platform winner data needed to be turned into a usable digital experience.",

      approach:
        "I designed and built an interactive dashboard with bank-level views, category comparisons, a side-by-side feature matrix, downloadable materials, and media-rich examples to make the research easier to explore.",

      result:
        "The finished tool transformed dense research data into a navigable product experience for reviewing scores, comparing institutions, exploring platform winners, and presenting supporting materials.",
    },
    ...
    capabilities: [
      {
        ...
        summary:
          "Took the tool from concept to a structured dashboard experience, designing the navigation, views, and comparison flows around how users needed to explore the research.",
      },
      {
        title: "Research Workflow Translation",
        summary:
          "Worked with analysts to turn scoring models, feature categories, bank comparisons, and reporting needs into clear interactive screens.",
      },
      {
        title: "Frontend Development & Data Integration",
        summary:
          "Built the application interface with reusable components and connected it to structured research data so scores, categories, feature details, and comparison views could render dynamically.",
      },
      {
        title: "Interactive & Media-Rich Presentation",
        summary:
          "Created comparison tools, video-supported feature examples, and downloadable material sections to make the research easier to explore and present.",
      },
    ],

    stack: ["nextjs", "react", "filemaker", "framermotion", "css", "amplify"],
    ...
    caseStudy: {
      overview:
        "Digital Insights Hub is an interactive research dashboard built to evaluate, rank, and compare digital business banking features across financial institutions. The platform turns a complex research program into a structured product experience with bank views, category views, side-by-side comparison tools, downloadable materials, and video-based feature examples.",

      highlights: [
        "Built a bank-specific view for reviewing test drive features, scores, and performance results",
        "Created category views for comparing how different banks performed across specific digital banking feature areas",
        "Developed an interactive feature matrix for comparing the features of up to six banks side by side",
        "Added downloadable materials for program content, including annual report materials",
        "Integrated video examples to show how specific digital banking features appeared in practice",
        "Designed the experience to support both research exploration and presentation workflows",
        "Built the tool from concept through export, including interface design, frontend development, data integration, and deployment",
      ],
    },
    ...
    media: [
      ...
      },
      {
        ...
        description:
          "A category-based view for comparing how different banks performed across specific digital business banking feature areas.",
    ...
    seo: {
      title: "Digital Insights Hub Project | Nicholas Egner",
      description:
        "An interactive research dashboard project designed and built by Nicholas Egner to evaluate, rank, and compare digital business banking experiences across financial institutions.",
    },
  },
